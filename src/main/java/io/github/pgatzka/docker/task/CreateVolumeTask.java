...
public abstract class CreateVolumeTask extends DockerTask {
    ...
    @Input public abstract MapProperty<String, String> getDriverOpts();
    ...
    static void run(DockerClient c, String name, String driver,
                    Map<String, String> opts, Map<String, String> labels, Logger log) {
